    ...
    <div className={notoSansThai.className} style={{ background: "#fff", minHeight: "100vh", padding: 0 }}>
      ...
      >
        ...
        <div style={{ color: '#222', fontSize: 15, textAlign: 'center', marginBottom: 12, fontWeight: 500 }}>
          เราได้ส่งข้อมูลไปยังอีเมลของคุณแล้ว<br />
          กรุณาตรวจสอบอีเมลของคุณแล้วเปลี่ยนรหัสผ่าน
        </div>
        <div style={{ color: '#888', fontSize: 14, textAlign: 'center', marginBottom: 32, fontWeight: 400 }}>
          หากคุณไม่พบข้อมูลที่พวกเราส่งให้<br />
          กรุณาตรวจสอบใน spam หรือ junk
        </div>
        {/* Button */}
        <button
