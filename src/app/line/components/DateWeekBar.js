...
export default function DateWeekBar({
  ...
  const fmtThaiDay = new Intl.DateTimeFormat('th-TH-u-ca-buddhist', {
    day: 'numeric',
  });
  const fmtThaiMonthYear = new Intl.DateTimeFormat('th-TH-u-ca-buddhist', {
    month: 'long',
    year: 'numeric',
  });
  const fmtThaiDateSlash = new Intl.DateTimeFormat('th-TH-u-ca-buddhist', {
    day: '2-digit',
    month: '2-digit',
    year: 'numeric',
  });
  ...
  const weekRangeLabel = useMemo(() => {
    ...
    const full = new Intl.DateTimeFormat('th-TH-u-ca-buddhist', {
      day: 'numeric',
      month: 'long',
      year: 'numeric',
    });
  ...
  return (
    <div className="datebar">
      <div className="datebar-left">
        <time className="datebar-today">
          {fmtThaiDateSlash.format(refDate)}
        </time>
      </div>
